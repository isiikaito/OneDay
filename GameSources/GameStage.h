...
namespace basecross {
	...
	public:
		...
		*/
		GameStage() :Stage(), m_woodScale(Vec3(10.0f)), m_meteScale(Vec3(5.0f)), m_woodenBoxScale(Vec3(9.0f)), m_keyScale(2.0f, 4.0f, 1.0f), m_BuildingScale(10.0f), m_startEye(Vec3(0.0f, 5.0f, -5.0f)), m_startAt(Vec3(0.0f)), m_totalTime(31.0f), m_oneday(0), m_emissiveChangeTime(1.0f), m_dayTime(0.0f), m_GameTime(31.0f), m_MeatNumber(0), m_MeatTime(0.0f), m_Date(0), m_playerChangeTime(0.0f), m_gameStrat(true), m_gameStartTime(0.0f), m_CameraSelect(CameraSelect::openingCamera) {}
